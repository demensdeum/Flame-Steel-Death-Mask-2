export const localizedStrings = {
    "en": {
        "WELCOME": "Masonry-AR - an augmented reality game, access to your geolocation is required. The game uses cookies and closely monitors you in the name of the Great Lodge.\nThe developer is not responsible for the consequences of the game. By clicking OK, you agree to this.",
        "LOCATION_GOT_WELCOME_MESSAGE": "Your coordinates have been determined. To move in the game, walk with your device in real life, collect Masonic signs, and build buildings for your order. Enjoy the game!",
        "CANT_BUILD_NO_CLIENT_COORDINATES": "Can't build, Masons need your coordinates!",
        ...
        "TOO_FAST_ERROR": "To build buildings, you must first stop and wait (coordinates on the server and client are different)",
        "ADD_ORDER_NAME_ERROR": "You must set a name for your order to build the building!"
    },
    "ru": {
        ...
        "LOCATION_GOT_WELCOME_MESSAGE": "Ваши координаты определены.\nДля перемещения в игре ходите с устройством в реальной жизни, собирайте масонские знаки, стройте здания за свой орден.\nПриятной игры!",
        "CANT_BUILD_NO_CLIENT_COORDINATES": "Строить нельзя пока не будут определены ваши координаты!",
        ...
        "TOO_FAST_ERROR": "Для постройки зданий сначала нужно остановиться и подождать (координаты на сервере и на клиенте разные)",
        "ADD_ORDER_NAME_ERROR": "Для постройки здания задайте название своему ордену!"
    }
};
